...
SQL_OPTIMIZATION_SYSTEM_PROMPT = r"""你是一位专业的SQL查询优化专家，擅长分析和优化医疗数据库查询性能。
...
SQL_RESULT_ANALYSIS_SYSTEM_PROMPT = r"""你是一位专业的医疗数据分析师，擅长解读SQL查询结果并提供医学洞察。
